========================================================================
    APLICACIÓN DE CONSOLA: Proyecto Final Estructura Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Proyecto Final Estructura.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación Proyecto Final Estructura.


Proyecto Final Estructura.vcxproj
...
Proyecto Final Estructura.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado Proyecto Final Estructura.pch y un archivo de tipos precompilados llamado StdAfx.obj.
